...
- features/conversation: shared multi-character session history, archive drawer and conversation controls.
...
- backend: LLM and speech providers, prompts, Agent runtime, secure tools, SQLite sessions and audit lifecycle.
